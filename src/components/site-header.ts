...
export class SiteHeader extends LitElement {
  ...
  public static styles = css`
    ...
    .mobile-menu-button[aria-expanded="true"] .mobile-menu-icon span {
      opacity: 0;
    }
  ...
  public render() {
    return html`
      <header class="site-header">
        <a class="brand" href="/" @click=${this.closeMobileMenu}
          ><img
            class="brand-logo"
            src="/images/logo.jpg"
          ...
          /><span class="brand-text"
            ...
            ><span class="brand-subtitle">Båtforening</span></span
          ></a
        >
        <nav class="navigation" aria-label="Hovedmeny">
          <a href="/">Hjem</a>
          <div class="dropdown">
            <button class="dropdown-button" type="button">Organisering</button>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a href="/informasjon/gjest-i-havna">Gjest i havna</a
              ><a href="/informasjon/severdigheter">Severdigheter</a
              ><a href="/informasjon/slipoppsett">Slipoppsett</a
              ><a href="/informasjon/oppstilling-landomrade"
                >Oppstilling landområde</a
              ><a href="/informasjon/vare-priser">Våre priser</a
              ><a href="/informasjon/bilder">Bilder</a>
            </div>
          </div>
          <div class="dropdown">
            ...
            <div class="dropdown-menu">
              ...
              ><a href="/reglement/fortoyning">Fortøyning</a
              ><a href="/reglement/beredskapsplan">Beredskapsplan</a
              ><a href="/reglement/avfallshandtering">Avfallshåndtering</a>
            </div>
          </div>
      ...
      >
        <div class="mobile-nav-links">
          ...
          <details>
            ...
            <a
              href="/organisering/kontaktpersoner"
              @click=${this.closeMobileMenu}
              >Kontaktpersoner</a
            >
            <a href="/organisering/vedtekter" @click=${this.closeMobileMenu}
              >Vedtekter</a
            >
          </details>
          <details>
            <summary>Informasjon</summary>
            <a href="/informasjon/gjest-i-havna" @click=${this.closeMobileMenu}
              >Gjest i havna</a
            >
            <a href="/informasjon/severdigheter" @click=${this.closeMobileMenu}
              >Severdigheter</a
            >
            <a href="/informasjon/slipoppsett" @click=${this.closeMobileMenu}
              >Slipoppsett</a
            >
            <a
              href="/informasjon/oppstilling-landomrade"
              @click=${this.closeMobileMenu}
              >Oppstilling landområde</a
            >
            <a href="/informasjon/vare-priser" @click=${this.closeMobileMenu}
              >Våre priser</a
            >
            <a href="/informasjon/bilder" @click=${this.closeMobileMenu}
              >Bilder</a
            >
          </details>
          <details>
            <summary>Reglement</summary>
            <a href="/reglement/hms-plan" @click=${this.closeMobileMenu}
              >HMS plan</a
            >
            <a href="/reglement/fortoyning" @click=${this.closeMobileMenu}
              >Fortøyning</a
            >
            <a href="/reglement/beredskapsplan" @click=${this.closeMobileMenu}
              >Beredskapsplan</a
            >
            <a
              href="/reglement/avfallshandtering"
              @click=${this.closeMobileMenu}
              >Avfallshåndtering</a
            >
          </details>
